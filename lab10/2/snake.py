...
class apple(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("pp2/lab10/2/apple.PNG") #loading apple image
...
class pear(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("pp2/lab10/2/pear.PNG") #loading pear image
...
class banana(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("pp2/lab10/2/Banana.PNG") #loading banana image
...
# Play music
def play_music():
    pygame.mixer.music.load("pp2/lab10/2/background.wav")
